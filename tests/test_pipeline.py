...
def test_config():
    from avica.pipe.main import AvicaPipeline
    from avica.pipe.core import PipelineContext, NamedTuple

    pipe = AvicaPipeline(pipe_params={"fitsfiles": ["/"+"home/avi/intelligence/jupyter/vscode/BW034/wd_2/raw/VLBA_VSN001540_file10.uvfits"]})
...
def test_pipearch():
    ...
    from avica.pipe.core import PipelineStepBase, AvicaPipelineCore, PipelineStepValidatorBase, B,BC, X, Y, D
    ...
    class DemoPipeline(AvicaPipelineCore):
...
def test_preprocess_fitsidi():
    ...
    # from avica.fitsidiutil import ObservationSummary, SplitData, fitsidi_check, read_idi
    # from avica.fitsidiutil.io import FITS_TYPE_MAP
    ...
    # # main_pipeline.filter_steps("avica_fill_input","avica_split_ms","rpicard")
